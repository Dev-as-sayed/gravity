...
export const studentNavItems: NavItem[] = [
  ...
  { name: "My Results", icon: Award, path: "/dashboard/student/results" },
  {
    name: "Ask Doubt",
    icon: MessageCircle,
    path: "/dashboard/student/ask-doubt",
  },
  { name: "My Doubts", icon: HelpCircle, path: "/dashboard/student/my-doubts" },
  ...
  { name: "Performance", icon: BarChart, path: "/dashboard/student/analytics" },
  {
    name: "Achievements",
    icon: Trophy,
  ...
  { name: "Fee Details", icon: CreditCard, path: "/dashboard/student/fees" },
  {
    name: "Payment History",
    icon: History,
    path: "/dashboard/student/payments",
  },
  { name: "Invoices", icon: Receipt, path: "/dashboard/student/invoices" },
